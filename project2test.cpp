...
int main()
{
    ...
    cout << "A table with values of the growth rate r and the doubling time Td, given R_0, of a simulated epidemic using the SIR model." << endl;
    cout << "| "
         << setw(10)
         << "R_0"
         << " | "
    ...
    for (j = 0; j < 3; j++)
    {
        ...
        for (i = 0; i < M - 1; i++)
        {
            ...
            double a_1{N * mu};
            double a_2{reproduction_number[j] * (gamma + mu) * S * I / N};
            double a_3{gamma * I};
            double a_4{mu * S};
            double a_5{mu * I};
            double a_6{mu * R};
